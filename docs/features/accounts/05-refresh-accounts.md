...
- `build/verification/refresh-active-relinks-same-account/workflow-receipt.json`;
- `build/verification/refresh-active-relinks-same-account/scenario-summary.json`.
