...
- Kite scenario receipt for `add-account-name-validation`.
- focused test output from `AddAccountWorkflowTests`, `AccountsControllerTests`,
  and `AccountActionFlowTests`;
- Kite scenario receipt for `add-account-isolated-success`.
...
- Kite scenario receipt for `add-account-failure-cleanup`.
